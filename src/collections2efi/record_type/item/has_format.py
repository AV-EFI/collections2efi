...
def get_from_file_type(xml: XMLAccessor):
...
def get_from_mat_characteristics(xml: XMLAccessor):
    formats = []
...
def get_from_material_type_video(xml: XMLAccessor):
...
def get_from_material_type_digitalvideo(xml: XMLAccessor):
    formats = []
